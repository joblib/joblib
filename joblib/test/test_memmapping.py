...
@parametrize(
    "factory,retry_no",
    list(itertools.product([MemmappingPool, _TestingMemmappingExecutor], range(3))),  # noqa
    ids=['{}, {}'.format(x, y) for x, y in itertools.product(["multiprocessing", "loky"], map(str, range(3)))])  # noqa
