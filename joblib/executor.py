...
class MemmappingExecutor(_ReusablePoolExecutor):
    ...
    def terminate(self, kill_workers=False):
        ...
        # When workers are killed in a brutal manner, they cannot
        # execute the finalizer of their shared memmaps. The refcount
        # of those memmaps may be off by an unknown number, so instead
        # of decref'ing them, we force delete the whole temporary folder,
        # and unregister them. There is no risk of PermissionError at
