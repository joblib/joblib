...
def get_func_name(func, resolv_alias=True, win_characters=True):
    ...
    if module == '__main__':
        ...
        if filename is not None:
            ...
            is_jupyter = (
                parts[-1].startswith('<ipython-input') or
                (len(parts) > 2 and parts[-2].startswith('ipykernel_')) or
                ("xpython_" in parts[-2])
            )
            if is_jupyter:
                # Source filenames generated by ipykernel sessions from jupyter
                # do not give enough information to reconstruct the name
                # of the original ".ipynb" source file so we have to scope such
                # functions in a jupyter specific manner.
                #
                ...
                # collide with the scope of function defined in regular Python
                # source files.
                #
